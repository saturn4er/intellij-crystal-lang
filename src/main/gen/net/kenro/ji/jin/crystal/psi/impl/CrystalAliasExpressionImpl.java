...
public class CrystalAliasExpressionImpl extends ASTWrapperPsiElement implements CrystalAliasExpression {

  public CrystalAliasExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
