...
public class CrystalEnvironmentCrystalPathModificationTracker {
    ...
    public CrystalEnvironmentCrystalPathModificationTracker() {
//        String goPath = CrystalEnvironmentUtil.retrieveGoPathFromEnvironment();
//        if (goPath != null) {
...
//        recalculateFiles();
    ...
    public static Collection<VirtualFile> getGoEnvironmentGoPathRoots() {
        return ServiceManager.getService(CrystalEnvironmentCrystalPathModificationTracker.class).getGoPathRoots();
    }
}
