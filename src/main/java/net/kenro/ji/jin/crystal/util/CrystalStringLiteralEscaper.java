...
public class CrystalStringLiteralEscaper extends LiteralTextEscaper<CrystalStringLiteral> {

  private int[] outSourceOffsets;

  public CrystalStringLiteralEscaper(@NotNull CrystalStringLiteral host) {
    super(host);
  }
